...
Me-Burger (`CLAUDE.md`) and these protocols, does the work, and that instance ends
...
```
homer/
├── CLAUDE.md            # The Me-Burger — single source of truth. Start here.
├── README.md            # This file — Homer's voice.
├── protocol/            # Working agreements (gates, signatures, status colors)
└── prompts/             # Reusable Garfield prompt templates (the rapid-loop seed)
```

Point any fresh Claude/AI conversation at `CLAUDE.md` and Homer boots grounded.
